...
<section class="p-category">
   ...
   <a href="category.php?category=PTS">PTS</a>
   <a href="category.php?category=PTN">PTN</a>

</section>

<section class="univ">

   <h1 class="title">latest university</h1>
   ...
   <?php
      ...
      echo '<p class="empty">no university added yet!</p>';
   }
   ?>
