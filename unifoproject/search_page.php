...
<section class="search-form">
   ...
   <form action="" method="POST">
      <input type="text" class="box" name="search_box" placeholder="search university...">
...
<section class="univ" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
      ...
      $select_univ = $conn->prepare("SELECT * FROM `univ` WHERE name LIKE '%{$search_box}%' OR category LIKE '%{$search_box}%'");
      $select_univ->execute();
